 ...
 *
 * Calls fs_mount() using the pre-configured FAT mount point.
 * Should be called once during initialisation before any file I/O.
 *
 ...
 *
 * Opens or creates @p fname, writes @p data, then closes the file.
 *
 ...
 *
 * Intended to be started as a Zephyr thread from main or via
 * K_THREAD_DEFINE().
 */
